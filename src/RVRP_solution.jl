...
struct Route
    ...
    end_status::Int # 0 returnToStartDepot, 1 returnToOtherDepot, 2 ongoing # post-computed
...
struct RvrpSolution
    ...
    routes::Vector{Route}
    unassigned_request_ids::Vector{String} # among semi-mandatory or optional request # post-computed
end
