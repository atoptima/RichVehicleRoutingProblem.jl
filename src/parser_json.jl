...
JSON2.@format Request begin
    ...
    vehicle_or_compartment_capacity_consumptions => (default=Dict{String,Tuple{Float64,Float64}}(),)
    vehicle_or_compartment_property_requirements => (default=Dict{String,Float64}(),)
